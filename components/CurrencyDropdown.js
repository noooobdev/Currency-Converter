    ...
    <div className="relative w-full text-left">
      <div>
        <button
          ref={buttonRef}
          type="button"
          className="inline-flex w-full justify-between rounded-md border gap-2 border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-100"
          id="menu-button"
          aria-expanded="false"
          aria-haspopup="true"
      ...
      >
        <div className="py-1 px-1" role="none">
          <div className="pt-2 relative mx-auto text-gray-600">
            <input
              ref={searchRef}
              className="searchBar border-2 border-gray-300 bg-white w-full h-10 px-5  rounded-lg text-sm focus:outline-none focus:border-0 focus:ring-2 focus:ring-indigo-500  focus:ring-offset-gray-100"
              type="text"
              name="search"
              placeholder="Search"
              value={currentValue}
